...
export function RouteGuard({ children }: { children: React.ReactNode }) {
  ...
  // Still reading storage or resolving the token. Rendering the login screen here would flash it in
  // front of users who are, in fact, signed in.
...
/**
 * Guards the public routes in the other direction: someone already signed in has no use for the
 * login screen.
 */
