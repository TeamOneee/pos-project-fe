    ...
    >
      <TabsPrimitive.Trigger
        ...
        className={cn(
          ...
          'data-[state=active]:bg-surface data-[state=active]:shadow-sm data-[state=active]:border-b-2 data-[state=active]:border-b-accent data-[state=inactive]:hover:bg-border/50',
