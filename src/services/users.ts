...
import { userSchema, type User } from '@/services/auth';
import { noData, type Role, type Status } from '@/api/schema';
...
export const usersApi = {
  ...
  get: (userId: string) => request({ method: 'GET', path: `/users/${userId}`, schema: userSchema }),
