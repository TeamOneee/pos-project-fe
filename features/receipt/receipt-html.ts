 ...
 * document — expo-print takes HTML on native, and the web print path writes it
 * into a frame. It carries its own `@page` sizing so the printer does not
 * impose margins a 58mm/80mm roll does not have.
 *
