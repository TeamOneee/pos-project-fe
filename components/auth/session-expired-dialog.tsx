 ...
 * lib/api/unauthorized.ts. One button, no dismiss: there is nothing useful the
 * user can do on the page behind it, so offering a way to stay would only
 * produce a screen full of failing requests.
 */
    ...
    <Dialog open={sessionExpired}>
      ...
      <DialogContent hideClose className="max-w-[400px]">
        <DialogHeader className="items-center gap-md">
          <View className="h-12 w-12 items-center justify-center rounded-full bg-warning-subtle">
        ...
        <DialogFooter>
          <Button className="w-full" onPress={acknowledgeSessionExpired}>
            <Text>Masuk</Text>
          </Button>
        </DialogFooter>
      </DialogContent>
